document.addEventListener("DOMContentLoaded", () => {
    ...
    const mottoElems = document.querySelectorAll('.motto-placeholder-new, .motto-title-new, .motto-footer-new, .third-section');
    mottoElems.forEach(el => mottoObserver.observe(el));
